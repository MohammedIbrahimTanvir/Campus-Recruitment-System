...
export const EducationEdit = ({ navigation }) => {
  ...
  const updateAlumniEducation = async () => {
    SetToken(authInfo.token);
    try {
      const response = await axios.post(
        "https://iiuc-campus-recuitement-system.herokuapp.com/profile/alumni/education",
        {
          school,
          college,
          university,
  ...
  return (
    <ScrollView>
      ...
      />
      <Button title="Update" onPress={updateAlumniEducation} />
    </ScrollView>
  );
};
